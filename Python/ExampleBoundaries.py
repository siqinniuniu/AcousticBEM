...
def TruncatedSphere():
    aVertex = np.array([[ 0.000D0,  0.000D0,  0.667D0],
                        ...
                        [-0.645D0, -0.372D0, -0.667D0],
                        [-0.645D0,  0.372D0, -0.667D0],
                        [ 0.000D0,  0.000D0, -1.000D0]], dtype=np.float32)

    aTriangle = np.array([[ 1,  3,  2], [ 1,  4,  3], [ 1,  5,  4], [ 1,  6,  5],
                          ...
                          [16, 17, 20], [17, 18, 20], [18, 19, 20], [19, 14, 20]], dtype=np.int32)
