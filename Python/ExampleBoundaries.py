...
def TruncatedSphere():
    aVertex = np.array([[ 0.000,  0.000,  0.667],
                        [ 0.000,  0.745,  0.667],
                        [ 0.645,  0.372,  0.667],
                        [ 0.645, -0.372,  0.667],
                        [ 0.000, -0.745,  0.667],
    ...
    aTriangle = np.array([[ 0,  2,  1], [ 0,  3,  2], [ 0,  4,  3], [ 0,  5,  4],
    ...
    return aVertex, aTriangle, nOpenTriangles

def TruncatedSphereRAD():
    aVertex = np.array([[0.000, 0.000],
                        [0.200, 0.000],
                        [0.400, 0.000],
                        [0.600, 0.000],
                        [0.800, 0.000],
    ...
    return aVertex, aElement, nOpenElements
